...
const VehicleRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        toast.success(
          `Parked in slot ${slot.slot_number}${
  ...
  const vehicleTypes = [
    ...
    },
    {
      ...
      icon: Zap,
      description: "Electric car with charging",
    },
    {
      value: "handicap",
      label: "Accessible",
      icon: Accessibility,
      description: "Handicap accessible parking",
    },
  ];
                      ...
                      {vehicleTypes.map((type) => {
                        ...
                        return (
                          <div
                            ...
                            onClick={() =>
                              !loading && setVehicleType(type.value)
                            }
                          >
